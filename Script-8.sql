 ...
 select * from students s 
 where date(created_on) = '2021-03-26 00:00:00'
 ...
 select * from students s 
 where date(created_on) = '2021-07-12 00:00:00'
 
 --14. Вывести пользователей которые были созданы 2021-07-12 00:00:00 и имеют пароль 1m313
 select * from students s 
 where date(created_on) = '2021-07-12 00:00:00' and password = '1m313'
 
 --15. Вывести пользователей которые были созданы 2021-07-12 00:00:00 и у которых в имени есть слово Andrey
 select * from students s 
 where date(created_on) = '2021-07-12 00:00:00' and name like '%Andrey%'
 
 --16. Вывести пользователей которые были созданы 2021-07-12 00:00:00 и у которых в имени есть цифра 8
 select * from students s 
 where date(created_on) = '2021-07-12 00:00:00' and name like '%8%'
 ...
 select * from students s 
 where date(created_on) in ('2020-10-03 00:00:00', '2021-05-19 00:00:00', '2021-03-26 00:00:00')
